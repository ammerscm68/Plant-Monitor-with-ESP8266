...
if (littleFSInit == true)
{
  ...
  if (TMessureLEDFlash == "True") {MessureLEDFlash = true;} else {MessureLEDFlash = false;}
...
if (sassid != "" && sapasswd != "") {
 ...
 // Topic-Name
  ...
  } else {SetupSave("soilmoist-sensorname.txt", samqttname);}
...
if (percentSoilMoist >= 30 && percentSoilMoist <= 60) {if (MessureLEDFlash == true) {SwitchLEDLight(false,true,false);}} 
else {if (MessureLEDFlash == true) {SwitchLEDLight(false,false,true);}}} // Flash Red or blue or green LED
