...
if (littleFSInit == true)
{
  ...
  if (lmqtt_username != "kA" && lmqtt_password != "kA" && IsMQTT != false) {
...
void GetSoilMoistValue() {
soilMoist = analogRead(soilMoistPin);
Serial.print("Analog Value: ");
Serial.print(soilMoist);
// Auswertung der Bodenfeuchtigkeit in Prozent
if (soilMoist > 10) {
percentSoilMoist = map(soilMoist, soilMoistLevelHigh+1, soilMoistLevelLow-1, 0, 100);} else {percentSoilMoist = 0;} // kein Messwert
