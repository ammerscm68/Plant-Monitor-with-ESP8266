...
if (server.method() == HTTP_POST) {
    ...
    lmqtthost = server.arg("mqtthost"); // MQTT-Host
    lmqtt_password = server.arg("mqtthostpwd"); // MQTT-Host Password
    lmqtt_username = server.arg("mqtthun"); // MQTT-Host Username
    mqtttopic = server.arg("mqtttop"); // MQTT-Topic
    ...
    HTMLString += "<br/>"; 
    // ******************************************* Parameter *****************************************************************************************************************************************************************************
    HTMLString += "<div class='form-floating'><br/><label>MQTT-Host (Optional)</label><input type='text' class='form-control' name='mqtthost' id='mqtthost' value='"+lmqtthost+"'></div>";
    HTMLString += "<div class='form-floating'><br/><label>MQTT-Host Username (Optional)</label><input type='text' class='form-control' name='mqtthun' id='mqtthun' value='"+lmqtt_username+"'></div>";
    HTMLString += "<div class='form-floating'><br/><label>MQTT-Host Password (Optional)</label><input type='text' class='form-control' name='mqtthostpwd' id='mqtthostpwd' value='"+lmqtt_password+"'></div>";
    HTMLString += "<div class='form-floating'><br/><label>MQTT-Topic (Example: /room/kitchen/planthumidity)</label><input type='text' class='form-control' name='mqtttop' id='mqtttop' value='"+mqtttopic+"'></div>";
