...
if (SoilCalibrate) {SoilCalibrate = false; GetSoilMoistValue(10);} // Nach dem Kalibrieren aktuellen Messwert holen
String RefreshTime = "";
...
MInterval = "Messintervall: alle "+(String)(soilMessureTrigger/2)+" Sekunden (Startmodus)";  
} else {MInterval = "Messintervall: alle "+measurementinterval+" Minuten";}
 yield();
 ...
 server.send(200, "text/html", 
  ...
  h2 { font-size: 32px; margin-top: 0px; margin-bottom: 50px; }\
