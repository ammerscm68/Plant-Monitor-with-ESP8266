...
done by a RESET on the website. If this is not possible then simply <br>
wait (when WLAN is switched off!) until the LED lights up only blue and the "Captive Portal" starts again. <br>
