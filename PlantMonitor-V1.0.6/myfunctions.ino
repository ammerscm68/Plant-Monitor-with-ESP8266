...
String sassid, sapasswd, samqtthost, samqtthostusername, samqtthostpassword, samqttname, samqtttopic, saWMSMLH, saWMSMLL;  
Serial.println(""); 
...
// Prüfen ob soilMoistLevelHigh und soilMoistLevelLow eine Zahl ist
...
// Daten unvollständig
 ...
 for (int i=0; i <= 5; i++){BlinkLED(BLAU);} // blau
