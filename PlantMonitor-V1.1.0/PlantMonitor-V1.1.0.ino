...
int MQTTTrigger = 10; // Messintervall
...
void setup()
{
  ...
  // Messurement-Trigger
  MQTTTrigger = measurementinterval1 * 60; // Messintervall von Minuten in Sekunden umrechnen
...
void loop()
{
  ...
  LoadValue += 1;
  if (LoadValue == 1 || LoadValue == MQTTTrigger) // Messurement Interval
  {
