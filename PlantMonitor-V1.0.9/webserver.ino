...
HTMLString = "<!DOCTYPE html> <html>\
  ...
  <meta http-equiv=\"content-type\" content=\"text/html; charset=utf-8\">\
   <style>\
  h2 {font-size: 36px; margin-top: 0px; margin-bottom: 50px;}\
  h3 {font-size: 18px; margin-top: 0px; margin-bottom: 50px; margin-left: 90px; font-weight: bold;}\
  ...
  <h1>+++ Pflanzen-Monitor +++</h1>\
    ...
    <body>\
    <font face=\"Arial\">\
     <a style=\"font-family:arial;color:black;font-size: 16px\">WLAN-Zugangsdaten werden gelöscht. (Die Parameter bleiben erhalten)</a>\
     <a><br /></a>\
     <a><br /></a>\
     <a><br /></a>\
     <h3>Der Access Point wird gestartet.</h3>\
     <h4>Bitte warten ...</h4>\
  </body>\
    </html>";
server.send(200, "text/html", HTMLString); 
